...
namespace SilverFlow.Controls.Extensions
{
    ...
    public static class ControlExtensions
    {
        ...
        /// <summary>
        /// Moves the element to the new container. The container can be a Panel or a Decorator derived class.
        /// </summary>
        /// <param name="element">The element.</param>
        ...
        /// <summary>
        /// Removes the element from its container. The container can be a Panel or a Decorator derived class.
        /// </summary>
        /// <param name="element">The element.</param>
