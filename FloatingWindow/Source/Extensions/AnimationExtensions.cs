...
namespace SilverFlow.Controls.Extensions
{
  ...
  public static class AnimationExtensions
  {
    ...
    {
      Duration duration = new Duration(TimeSpan.FromMilliseconds(milliseconds));
      DoubleAnimation doubleAnimation1 = new DoubleAnimation() { To = width, Duration = duration }; //note: Silverlight doesn't support parameters in DoubleAnimation's constructor
      DoubleAnimation doubleAnimation2 = new DoubleAnimation();
      PointAnimation pointAnimation = new PointAnimation() { To = position, Duration = duration };
