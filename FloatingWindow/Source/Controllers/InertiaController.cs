...
namespace SilverFlow.Controls.Controllers
{
    ...
    public class InertiaController
    {
        ...
        private const double COEFFICIENT_OF_SLIDING_FRICTION = 5.015; //TODO: This should be a window parameter (and also a container parameter to apply to all its windows) - 0.015 was the original value but was going toο fast, especially when used with zooming container (FloatingWindowHostZUI) - should also support 0 for no intertia
